...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        un_rate = recession_data.groupby(['Vehicle_Type', 'unemployment_rate'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
        	figure=px.line(
            	...
            	x='Year',
            	y='Automobile_Sales',
            	title='Average Yearly Automobile Sales in year {}'.format(input_year))
        )
...
#TASK 2.6: Returning the graphs for displaying Yearly data
        return [
                ...
                html.Div(className='chart-item', children=[html.Div(Y_chart3),html.Div(Y_chart4)],style={'dsiplay': 'flex'})
                ]
